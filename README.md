<div align="center">
  <!-- PORTRAIT - generated by dotify.py from Professional Picture-2.jpg.
       Colour mode, so one file serves both GitHub themes. Regenerate with:
         python3 dotify.py "Professional Picture-2.jpg" -o assets/portrait \
           --cols 110 --equalize --detail 0.8 --color --reveal --floor 0.3 -->
