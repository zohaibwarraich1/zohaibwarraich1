<div align="center">
  <!-- PORTRAIT - generated by dotify.py from me-remove.png.
       Colour mode, so one file serves both GitHub themes. Regenerate with:
         python3 dotify.py me-remove.png -o assets/portrait \
           --cols 160 --equalize --detail 0.8 --color --reveal --floor 0.1 -->
