<div align="center">
  <!-- PORTRAIT - generated by dotify.py from Professional_Picture-removebg-preview.png.
       Colour mode, so one file serves both GitHub themes. Regenerate with:
         python3 dotify.py Professional_Picture-removebg-preview.png -o assets/portrait \
           --cols 120 --equalize --detail 0.8 --color --reveal --floor 0.2 -->
  <img src="assets/portrait.svg" width="300" alt="Muhammad Zohaib Warraich, rendered as a dot matrix">
</div>
